...
public class assertExtentOfCExecution extends OpaqueBehaviorExecution
{
	...
	{
		System.out.println("Asserting C.allInstances()->size() == 0");	

	int extentSize = inputParameters.get(0).values.size();
	
	System.out.println("C.allInstances()->size() == " + extentSize);
	System.out.print("All instances of C recursively destroyed: ");
