...
public abstract class Value extends fuml.semantics.loci.SemanticVisitor {
	...
	public abstract uml.values.ValueSpecification specify();
	...
	public abstract uml.classification.ClassifierList getTypes();

	public boolean hasType(uml.classification.Classifier type) {
	...
	public boolean isInstanceOf(uml.classification.Classifier classifier) {
	...
	public boolean checkAllParents(uml.classification.Classifier type,
			uml.classification.Classifier classifier) {
