...
public class AcceptEventAction extends uml.actions.Action {

	public boolean isUnmarshall = false;
	public uml.actions.OutputPinList result = new uml.actions.OutputPinList();
	public uml.commonbehavior.TriggerList trigger = new uml.commonbehavior.TriggerList();
	...
	public void addTrigger(
			uml.commonbehavior.Trigger trigger) {
